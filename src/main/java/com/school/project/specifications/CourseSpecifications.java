...
@Data
public class CourseSpecifications  implements Specification<Course> {
    ...
    public Predicate toPredicate(Root<Course> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        ...
        if(filter.getDescription() != null){
            Predicate description = criteriaBuilder.like(criteriaBuilder.upper(root.get("description")),"%"+filter.getDescription().toUpperCase() + "%");
